...
export const registryOpenApi = async (openApi, { branchName, filePath, id: repositoryId, userId, name }, commitId) => {
...
const createOpenApi = async (newOpenApiFileBuffer, repositoryId, userId) => {
  return Promise.all([
...
export const updateOpenApi = async (openApi, repositoryId, newOpenApiFileBuffer) => {
