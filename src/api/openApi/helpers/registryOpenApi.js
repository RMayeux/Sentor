...
export const registryOpenApi = async (openApi, session, repositoryName, prisma, { branchName, filePath, id: repositoryId, userId }) => {
...
const createOpenApi = async (newOpenApiFileBuffer, repositoryId, userId, prisma) => {
  console.log({ newOpenApiFileBuffer, repositoryId, userId, prisma });
  return Promise.all([
